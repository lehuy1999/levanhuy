                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <form action="" method="POST">
                                            <?php
                                                ...
                                                $id = $_GET['cm_news_1_id'];
                                                $sql_cm_1 = "SELECT * FROM cm_news_1 WHERE cm_news_1_id = $id";
                                        ...
                                        <?php
                                            if(isset($_POST['btnGui'])){
                                                ...
                                                $sql_cm_2 = "INSERT INTO cm_news_2(cm_news_1_id, username, cm_content) VALUES($id, '$username', '$content')";
