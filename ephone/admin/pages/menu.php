            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="form_product.php">Thêm sản phẩm mới</a>
                        </li>
                        <li>
                ...
                <!-- Đơn hàng -->
                <li>
                    <a href="list_order.php"><i class="fa fa-cart-plus fa-fw"></i> Đơn hàng</a>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="list_admin.php">Danh sách người quản trị</a>
                        </li>
                        <li>
                            <a href="list_user.php">Danh sách người dùng</a>
                        </li>
                        <li>
                            <a href="form_admin.php">Tạo tài khoản quản trị</a>
                        </li>
                        <li>
                            <a href="reset_password_account.php">Reset mật khẩu tài khoản</a>
                        </li>
                    </ul>
                </li>
